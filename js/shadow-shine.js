...
let camera, root, scene, renderer, renderer2, background;
let sphere;
let light;
...
function init() {
   ...
   /*  const button = makeElementObject('button', 75, 20)    
    ...
    ~function() {
        ...
        let geometry = new THREE.SphereBufferGeometry( 70, 32, 32 );
    ...
    // light
    ~function() {
        let ambientLight = new THREE.AmbientLight( 0x999999, 1.5 );
